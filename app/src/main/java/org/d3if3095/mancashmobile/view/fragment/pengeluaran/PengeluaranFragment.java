package org.d3if3095.mancashmobile.view.fragment.pengeluaran;
...
import org.d3if3095.mancashmobile.view.fragment.pengeluaran.add.AddPengeluaranActivity;
        ...
        pengeluaranViewModel.getPengeluaran().observe(requireActivity(),
                new Observer<List<ModelDatabase>>() {
                    ...
                    public void onChanged(List<ModelDatabase> pengeluaran) {
                        ...
                        Collections.reverse(pengeluaran);
